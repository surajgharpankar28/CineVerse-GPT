  ...
  return (
    <div className="absolute w-screen aspect-video pt-[20%] px-24 text-white bg-gradient-to-r from-black h-[100vh]">
      ...
      <div className="flex pt-4">
        <button className="flex font-medium bg-white text-black text-lg p-3 px-12 w-26 rounded-md hover:bg-opacity-80">
          <CIcon className="w-[1.3rem] m-auto mr-2" icon={cilMediaPlay} />
          Play
        </button>
        <button className="flex font-medium bg-gray-500 bg-opacity-30 text-white text-lg ml-4 p-3 px-12 w-26 rounded-md">
